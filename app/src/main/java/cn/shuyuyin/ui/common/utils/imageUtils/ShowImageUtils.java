package cn.shuyuyin.ui.common.utils.imageUtils;
...
public class ShowImageUtils {
    ...
    public static void showImageView(Context context, int errorimg, int imageId,
                                     ImageView imgeview) {
        Glide.with(context).load(imageId)// 加载图片
                .error(errorimg)// 设置错误图片
                .crossFade()// 设置淡入淡出效果，默认300ms，可以传参
                .placeholder(errorimg)// 设置占位图
                .diskCacheStrategy(DiskCacheStrategy.RESULT)// 缓存修改过的图片
