package cn.shuyuyin.ui.view.refresh;
...
public class CircleLoadMoreRefreshView extends CircleRefreshLayout {

    private static final String TAG = CircleLoadMoreRefreshView.class.getSimpleName();
    ...
    public CircleLoadMoreRefreshView(Context context, AttributeSet attrs) {
        super(context, attrs);
        // 填充底部加载布局
