...
public class WaitGoodsOrderListview extends LinearLayout {
	...
	public WaitGoodsOrderListview(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		this.context = context;
		init();
	}

	public WaitGoodsOrderListview(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		init();
	}

	public WaitGoodsOrderListview(Context context) {
		super(context);
		this.context = context;
		init();
	}
