...
import cn.shuyuyin.ui.adapter.TopicInAuditAdapter
 ...
 * 审核中
 */
class InAuditFragment:BaseFragment() {
    ...
    override fun setLayoutResID(): Int {
        return R.layout.fragment_in_audit
    }
    ...
    override fun initData() {
        ...
        val adapter = TopicInAuditAdapter(mContext)
