...
import cn.shuyuyin.ui.view.WaitGoodsOrderListview
import kotlinx.android.synthetic.main.fragment_wait_goods.*
import java.util.*
 ...
 * 待收货
 */
class WaitGoodsFragment:BaseFragment() {

    private val orders = ArrayList<OrderItemBean>()

    override fun setLayoutResID(): Int {
        return R.layout.fragment_wait_goods
    }
    ...
    private fun initListview() {
        for (order in orders) {
            val orderListview = WaitGoodsOrderListview(mContext)
