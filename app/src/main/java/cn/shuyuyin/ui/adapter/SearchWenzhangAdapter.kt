 ...
 */
class SearchWenzhangAdapter(val context: Context, layoutResId:Int = R.layout.item_personal_wenzhang, data:List<PersonalWenZhangListBean>): BaseQuickAdapter<PersonalWenZhangListBean, BaseViewHolder>(layoutResId,data) {
